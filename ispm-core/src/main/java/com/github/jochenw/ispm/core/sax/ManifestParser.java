...
public class ManifestParser extends AbstractContentHandler {
	...
	public void startElement(String pUri, String pLocalName, String pQName, Attributes pAttrs) throws SAXException {
		final @Nonnull String localName = Objects.requireNonNull(pLocalName);
		super.startElement(pUri, pLocalName, pQName, pAttrs);
		switch (getLevel()) {
		  case 1:
			  assertElement("Values", pUri, localName);
			  break;
		  case 2:
			  if (isElement("record", pUri, localName)) {
			  ...
			  } else if (isElement("value", pUri, localName)) {
			  ...
			  break;
		  case 3:
			  if (isElement("null", pUri, localName)) {
				  final String name = pAttrs.getValue("name");
	...
	public void endElement(String pUri, String pLocalName, String pQName) throws SAXException {
		final @Nonnull String localName = Objects.requireNonNull(pLocalName);
		final @Nonnull String qName = Objects.requireNonNull(pQName);
		super.endElement(pUri, localName, qName);
		switch(getLevel()) {
		case 1:
			if (inStartupServices) {
				inStartupServices = false;
